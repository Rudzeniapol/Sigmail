...
{
    /// <inheritdoc />
    public partial class IgnoreMessageReactionEntryEntity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReadBy = table.Column<List<Guid>>(type: "uuid[]", nullable: false),
                    DeliveredTo = table.Column<List<Guid>>(type: "uuid[]", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileImageUrl = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    Bio = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    IsOnline = table.Column<bool>(type: "boolean", nullable: false),
                    LastSeen = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CurrentDeviceToken = table.Column<string>(type: "text", nullable: true),
